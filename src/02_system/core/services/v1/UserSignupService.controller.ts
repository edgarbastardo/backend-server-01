...
export default class UserSignupServiceController {
                    ...
                    const sysUserSignup = await SYSUserSignupService.createOrUpdate(
                                                                                     {
                                                                                       ...
                                                                                       Avatar: signupData.Avatar ? signupData.Avatar: null,
      ...
      if ( !request.socket ||
        ...
        if ( bFrontendIdIsAllowed ) {
          ...
          if ( signupProcessData &&
            ...
            //const strRequestPath = `https://www.googleapis.com/oauth2/v3/tokeninfo?access_token=${request.body.TokenId}`;
            const strRequestPath = `https://oauth2.googleapis.com/tokeninfo?id_token=${request.body.TokenId}`;
            ...
            if ( callResult.status === 200 ) {
              ...
              result = {
                         StatusCode: 400, //Bad request
                         Code: 'ERROR_GOOGLE_TOKEN_NOT_VALID',
