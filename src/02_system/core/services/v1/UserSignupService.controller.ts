                        ...
                        sysUser = await SYSUserService.createOrUpdate(
                                                                       {
                                                                         ...
                                                                         ForceChangePassword: signupConfigProcessData.forceChangePassword || 0,
                                                                         ChangePasswordEvery: signupConfigProcessData.changePasswordEvery || 0,
                                                                         SessionLimit: signupConfigProcessData.sessionLimit || 0,
