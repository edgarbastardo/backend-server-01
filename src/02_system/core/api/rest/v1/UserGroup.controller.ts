...
export default class UserGroupController {
  ...
  static readonly _ROUTE_INFO = [
                                  ...
                                  { Path: UserGroupController._BASE_PATH, AccessKind: 3, RequestKind: 2, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#CreateUserGroupL03#,#CreateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "CreateUserGroupL03", "CreateUserGroupL04" ], Description: "Create new user group information" },
                                  { Path: UserGroupController._BASE_PATH, AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#UpdateUserGroupL03#,#UpdateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "UpdateUserGroupL03", "UpdateUserGroupL04" ], Description: "Update existent user group information" },
                                  { Path: UserGroupController._BASE_PATH + "/disable/bulk", AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#UpdateUserGroupL03#,#UpdateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "UpdateUserGroupL03", "UpdateUserGroupL04" ], Description: "Disable existent user account in bulk" },
                                  { Path: UserGroupController._BASE_PATH + "/enable/bulk", AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#UpdateUserGroupL03#,#UpdateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "UpdateUserGroupL03", "UpdateUserGroupL04" ], Description: "Enable existent user account in bulk" },
