...
export default class UserGroupController {
  ...
  static readonly _ROUTE_INFO = [
                                  {
                                    Path: UserGroupController._BASE_PATH,
                                    Action: "v1.system.group.user.get",
                                    AccessKind: 3,
                                    RequestKind: 1,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L01#,#Master_L03#,#Get_User_Group_L01#,#Get_User_Group_L03#,#Get_User_Group_L04#",
                                    Roles: [
                                             "Administrator",
                                             "BManager_L99",
                                             "Master_L01",
                                  ...
                                  {
                                    Path: UserGroupController._BASE_PATH,
                                    Action: "v1.system.group.user.create",
                                    AccessKind: 3,
                                    RequestKind: 2,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L03#,#Create_User_Group_L03#,#Create_User_Group_L04#",
                                    Roles: [
                                             "Administrator",
                                             "BManager_L99",
                                             "Master_L03",
                                             "Create_User_Group_L03",
                                             "Create_User_Group_L04"
                                           ],
                                    Description: "Create new user group information"
                                  },
                                  {
                                    Path: UserGroupController._BASE_PATH,
                                    Action: "v1.system.group.user.update",
                                    AccessKind: 3,
                                    RequestKind: 3,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L03#,#Update_User_Group_L03#,#Update_User_Group_L04#",
                                    Roles: [
                                             "Administrator",
                                             "BManager_L99",
                                             "Master_L03",
                                             "Update_User_Group_L03",
                                             "Update_User_Group_L04"
                                           ],
                                    Description: "Update existent user group information"
                                  },
                                  {
                                    Path: UserGroupController._BASE_PATH + "/disable/bulk",
                                    Action: "v1.system.group.user.disable.bulk",
                                    AccessKind: 3,
                                    RequestKind: 3,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L03#,#Update_User_Group_L03#,#Update_User_Group_L04#",
                                    Roles: [
                                    ...
                                    Description: "Disable existent user account in bulk"
                                  },
                                  {
                                    Path: UserGroupController._BASE_PATH + "/enable/bulk",
                                    Action: "v1.system.group.user.enable.bulk",
                                    AccessKind: 3,
                                    RequestKind: 3,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L03#,#Update_User_Group_L03#,#Update_User_Group_L04#",
                                    Roles: [
                                    ...
                                    Description: "Enable existent user account in bulk"
                                  },
                                  {
                                    Path: UserGroupController._BASE_PATH,
                                    Action: "v1.system.group.user.delete",
                                    AccessKind: 3,
                                    RequestKind: 4,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Delete_User_Group_L03#,#Delete_User_Group_L04#",
                                    Roles: [
                                             "Administrator",
                                             "BManager_L99",
                                             "Delete_User_Group_L03",
                                             "Delete_User_Group_L04"
                                           ],
                                    Description: "Delete the user group information"
                                  },
                                  {
                                    Path: UserGroupController._BASE_PATH + "/bulk",
                                    Action: "v1.system.group.user.delete.bulk",
                                    AccessKind: 3,
                                    RequestKind: 4,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Delete_User_Group_L03#,#Delete_User_Group_L04#",
                                    Roles: [
                                  ...
                                  {
                                    Path: UserGroupController._BASE_PATH + "/search",
                                    Action: "v1.system.group.user.search",
                                    AccessKind: 3,
                                    RequestKind: 1,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L01#,#Master_L03#,#Search_User_Group_L01#,#Search_User_Group_L03#,#Search_User_Group_L04#",
                                    Roles: [
                                             "Administrator",
                                             "BManager_L99",
                                             "Master_L01",
                                             "Master_L03",
                                             "Search_User_Group_L01",
                                             "Search_User_Group_L03",
                                             "Search_User_Group_L04"
                                           ],
                                    Description: "Search for user groups information"
                                  },
                                  {
                                    ...
                                    Description: "Count search user groups information result"
                                  },
                                  {
                                    Path: UserGroupController._BASE_PATH + "/settings",
                                    Action: "v1.system.group.user.settings.get",
                                    AccessKind: 2,
                                    RequestKind: 1,
                                    ...
                                    Description: "Get settings for the current user group" },
                                  {
                                    Path: UserGroupController._BASE_PATH + "/settings",
                                    Action: "v1.system.group.user.settings.set",
                                    AccessKind: 2,
                                    RequestKind: 3,
                                    AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L01#,#Master_L03#,#Settings_User_Group_L01#,#Settings_User_Group_L03#,#Settings_User_Group_L04#",
                                    Roles: [
                                             "Administrator",
                                             "BManager_L99",
                                             "Master_L01",
                                             "Master_L03",
                                             "#Settings_User_Group_L01#",
                                             "Settings_User_Group_L03",
                                             "Settings_User_Group_L04"
                                           ],
                                    Description: "Set settings for the current user group"
                                  },
                                ]
