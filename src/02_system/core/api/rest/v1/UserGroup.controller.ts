...
export default class UserGroupController {
  ...
  static readonly _ROUTE_INFO = [
                                  { Path: UserGroupController._BASE_PATH, Action: "v1.system.group.user.get", AccessKind: 3, RequestKind: 1, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL01#,#MasterL03#,#GetUserGroupL01#,#GetUserGroupL03#,#GetUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL01", "MasterL03", "GetUserGroupL01", "GetUserGroupL03", "GetUserGroupL04" ], Description: "Get the information for one user group" },
                                  { Path: UserGroupController._BASE_PATH, Action: "v1.system.group.user.create", AccessKind: 3, RequestKind: 2, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#CreateUserGroupL03#,#CreateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "CreateUserGroupL03", "CreateUserGroupL04" ], Description: "Create new user group information" },
                                  { Path: UserGroupController._BASE_PATH, Action: "v1.system.group.user.update", AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#UpdateUserGroupL03#,#UpdateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "UpdateUserGroupL03", "UpdateUserGroupL04" ], Description: "Update existent user group information" },
                                  { Path: UserGroupController._BASE_PATH + "/disable/bulk", Action: "v1.system.group.user.disable.bulk", AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#UpdateUserGroupL03#,#UpdateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "UpdateUserGroupL03", "UpdateUserGroupL04" ], Description: "Disable existent user account in bulk" },
                                  { Path: UserGroupController._BASE_PATH + "/enable/bulk", Action: "v1.system.group.user.enable.bulk", AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL03#,#UpdateUserGroupL03#,#UpdateUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL03", "UpdateUserGroupL03", "UpdateUserGroupL04" ], Description: "Enable existent user account in bulk" },
                                  { Path: UserGroupController._BASE_PATH, Action: "v1.system.group.user.delete", AccessKind: 3, RequestKind: 4, AllowTagAccess: "#Administrator#,#BManagerL99#,#DeleteUserGroupL03#,#DeleteUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "DeleteUserGroupL03", "DeleteUserGroupL04" ], Description: "Delete the user group information" },
                                  { Path: UserGroupController._BASE_PATH + "/bulk", Action: "v1.system.group.user.delete.bulk", AccessKind: 3, RequestKind: 4, AllowTagAccess: "#Administrator#,#BManagerL99#,#DeleteUserGroupL03#,#DeleteUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "DeleteUserGroupL03", "DeleteUserGroupL04" ], Description: "Delete the user information in bulk" },
                                  { Path: UserGroupController._BASE_PATH + "/search", Action: "v1.system.group.user.search", AccessKind: 3, RequestKind: 1, AllowTagAccess: "#Administrator#,#BManagerL99#,#MasterL01#,#MasterL03#,#SearchUserGroupL01#,#SearchUserGroupL03#,#SearchUserGroupL04#", Roles: [ "Administrator", "BManagerL99", "MasterL01", "MasterL03", "SearchUserGroupL01", "SearchUserGroupL03", "SearchUserGroupL04" ], Description: "Search for user groups information" },
