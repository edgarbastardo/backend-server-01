...
export default class BinaryController {
  ...
  static readonly _ROUTE_INFO = [
                                  ...
                                  { Path: BinaryController._BASE_PATH, Action: "v1.system.binary.upload", AccessKind: 3, RequestKind: 2, AllowTagAccess: "#Administrator#,#Business_Manager#,#BManager_L99#,#Master_L01#,#Master_L02#,#Master_L03#,#UploadBinary#", Roles: [ "Administrator", "BManager_L99", "Master_L01", "Master_L02", "Master_L03", "UploadBinary" ], Description: "Upload binary data to the backend server" },
                                  { Path: BinaryController._BASE_PATH, Action: "v1.system.binary.update", AccessKind: 3, RequestKind: 3, AllowTagAccess: "#Administrator#,#Business_Manager#,#BManager_L99#,#Master_L01#,#Master_L02#,#Master_L03#,#Update_Binary#,#Update_Binary_L01#,#Update_Binary_L02#,#Update_Binary_L03#", Roles: [ "Administrator", "BManager_L99", "Master_L01", "Master_L02", "Master_L03", "Update_Binary", "Update_Binary_L01", "Update_Binary_L02", "Update_Binary_L03" ], Description: "Update the information metadata of binary data from backend server" },
