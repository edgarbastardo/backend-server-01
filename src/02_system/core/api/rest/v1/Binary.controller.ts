...
export default class BinaryController {
  ...
  static readonly _ROUTE_INFO = [
                                  ...
                                  { Path: BinaryController._BASE_PATH, Action: "v1.system.binary.upload", AccessKind: 3, RequestKind: 2, AllowTagAccess: "#Administrator#,#BManager_L99#,#Master_L01#,#Master_L02#,#Master_L03#,#UploadBinary#", Roles: [ "Administrator", "BManager_L99", "Master_L01", "Master_L02", "Master_L03", "UploadBinary" ], Description: "Upload binary data to the backend server" },
