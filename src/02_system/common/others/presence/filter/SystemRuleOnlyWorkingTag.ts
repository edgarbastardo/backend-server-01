  ...
  async filterList( userSessionStatus: any,
    ...
    try {
      ...
      for ( let intIndex = 0; intIndex < userPresenceList.length; intIndex++ ) {
        ...
        if ( ( userPresence.sysUser.Role && userPresence.sysUser.Role.includes( "#Presence_Working#" ) ) ||
             ( userPresence.sysUserGroup.Role && userPresence.sysUserGroup.Role.includes( "#Presence_Working#" ) ) ) {
