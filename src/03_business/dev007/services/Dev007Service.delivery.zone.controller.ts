      ...
      if ( validator.passes() ) { //Validate request.body field values
        ...
        if ( !bizDeliveryZoneInDB ) {
          ...
          bizDeliveryZoneInDB = await BIZDeliveryZoneService.createOrUpdate( {
                                                                               ...
                                                                               DistanceUnit: request.body.DistanceUnit, //0 = Miles,1 = Kilometers
                                                                               DistanceCalcKind: request.body.DistanceCalcKind,
                                                                               DistanceBase: request.body.DistanceBase,
                                                                               DistanceMax: request.body.DistanceMax,
                                                                               DistanceExtraCalcKind: request.body.DistanceExtraCalcKind,
                                                                               DistanceExtraByUnit: request.body.DistanceExtraByUnit,
                                                                               DeliveryByDriverMax: request.body.DeliveryByDriverMax,
