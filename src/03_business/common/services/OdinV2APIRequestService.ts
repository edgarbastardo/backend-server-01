...
export default class OdinV2APIRequestService {
  ...
  static async callGetNewDeliveryOrder( backend: any,
                                        headers: any,
    ...
    try {
      ...
      let strRequestURL = backend.url[ 0 ] + "/v1/business/dev007/export/delivery/order?DeliveryAt=" + params.DeliveryAt;
  ...
  static async callNewDeliveryOrderMark( backend: any,
                                         headers: any,
    ...
    try {
      ...
      const strRequestURL = backend.url[ 0 ] + "/v1/business/dev007/export/delivery/order/mark";
