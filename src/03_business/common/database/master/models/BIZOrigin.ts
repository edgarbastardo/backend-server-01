...
const debug = require( "debug" )( "BIZOrigin" );
...
export class BIZOrigin extends Model<BIZOrigin> {
  ...
  @BeforeValidate
  static beforeValidateHook( instance: BIZOrigin, options: any ): void {
  ...
  @BeforeCreate
  static beforeCreateHook( instance: BIZOrigin, options: any ): void {
  ...
  @BeforeUpdate
  static beforeUpdateHook( instance: BIZOrigin, options: any ): void {
  ...
  @BeforeDestroy
  static beforeDestroyHook( instance: BIZOrigin, options: any ): void {
