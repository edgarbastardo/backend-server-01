...
const debug = require( "debug" )( "BIZDeliveryZone" );

@Table( {
  timestamps: false,
  tableName: "bizDeliveryZone",
  modelName: "bizDeliveryZone"
} )
export class BIZDeliveryZone extends Model<BIZDeliveryZone> {
  ...
  @BeforeValidate
  static beforeValidateHook( instance: BIZDeliveryZone, options: any ): void {
  ...
  @BeforeCreate
  static beforeCreateHook( instance: BIZDeliveryZone, options: any ): void {
  ...
  @BeforeUpdate
  static beforeUpdateHook( instance: BIZDeliveryZone, options: any ): void {
  ...
  @BeforeDestroy
  static beforeDestroyHook( instance: BIZDeliveryZone, options: any ): void {
  ...
  static async convertFieldValues( params: any ): Promise<any> {
    ...
    try {
      ...
      const strMark = "C5F97C0964D0" + ( cluster.worker && cluster.worker.id ? "-" + cluster.worker.id : "" );
