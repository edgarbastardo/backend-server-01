      ...
      const userSessionPersistentEntries = [
                                             {
                                               ...
                                               Tag: "#ForeignSystem#,#ForeignSystem01#,#Upload_Binary#,#Update_Binary#,#Search_Binary#,#BinaryDataAllowToDefineId#,#BinaryDataAllowToDefineDate#",
                                             ...
                                             {
                                               Id: "72ebd6b5-0dd9-4f8d-9e93-37a6e1c83f45",
                                               UserId: "56adc517-e571-41f7-90be-5c5e97909c99",
                                               Token: process.env.FOREIGN_SYSTEM_998_TOKEN || "998",
                                               BinaryDataToken: process.env.FOREIGN_SYSTEM_998_BINARY_DATA_TOKEN || null,
                                               SocketToken: process.env.FOREIGN_SYSTEM_998_SOCKET_TOKEN || null,
                                               Tag: "#ForeignSystem#,#ForeignSystem998#",
                                               Comment: "Generic authorization token (API KEY)",
                                               CreatedBy: SystemConstants._CREATED_BY_BACKEND_SYSTEM_NET,
                                               DisabledBy: null //"1@" + SystemConstants._DISABLED_BY_BACKEND_SYSTEM_NET,
                                             },
