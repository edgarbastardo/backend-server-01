      ...
      const configValueEntries = [
                                    ...
                                    */
                                    ...
                                    },
                                    {
                                      ...
                                      Owner: SystemConstants._USER_BACKEND_SYSTEM_NET_NAME,
                                      Value: `{ "@__default__@": { "expireAt": 60, "group": "@__error__@", "createGroup": false, "groupRole": "", "groupTag": "", "groupExpireAt": -1, "status": -1, "userRole": "", "userTag": "", "passwordParameterTag": "" }, "#driver#": { "expireAt": 60, "group": "Drivers", "createGroup": false, "groupRole": "", "groupTag": "", "groupExpireAt": -1, "status": 1, "userRole": "#Driver#", "userTag": "", "userExpireAt": -1, "passwordParameterTag": "" }, "#finalCustomer#": { "expireAt": 60, "group": "Final_Customers", "createGroup": false, "groupRole": "", "groupTag": "", "groupExpireAt": -1, "status": 1, "userRole": "#FinalCustomer#", "userTag": "", "userExpireAt": -1, "passwordParameterTag": "" }, "#establishment#": { "expireAt": 60, "group": "@__FromName__@", "createGroup": true, "groupRole": "#@__FromName__@#,#Establishment#", "groupTag": "", "groupExpireAt": -1, "status": 1, "userRole": "#Master#", "userTag": "", "userExpireAt": -1, "passwordParameterTag": "#Establishments#" } }`,
                                      CreatedBy: SystemConstants._CREATED_BY_BACKEND_SYSTEM_NET,
                                    },
                                    {
