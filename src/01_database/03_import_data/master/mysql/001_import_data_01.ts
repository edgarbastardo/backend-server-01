...
export default class Import {
  ...
  static async importUp( dbConnection: any, logger: any ): Promise<any> {
    ...
    try {
      ...
      const strValues = "'" + strId + "','" + strShortId + "','Group01','#Administrator#','Group test created with migration','backend@system.net','" + SystemUtilities.getCurrentDateAndTime().format( CommonConstants._DATE_TIME_LONG_FORMAT_ISO8601_Millis ) + "'";
