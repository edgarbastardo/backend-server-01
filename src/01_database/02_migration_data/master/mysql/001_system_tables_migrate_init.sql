...
CREATE TABLE IF NOT EXISTS `sysBinaryIndex` (
  ...
  `ExpireAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Date and time when expire the binary data, used for StorageKind = 1 (Temporal)',
...
--  `AllowTagAccess` varchar(2048) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'List of name/id of groups or users split by , and sourrounded by # to allow access this binary\n\nExample:\n\n#group01#, #manager01@system.net#, #exporter#\n\n* = Any access to this record\nnull = no access defined',
  ...
  `DisabledAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Disable Date and time of the row.',
  `ProcessNeeded` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0=No, 1=Yes',
  `ProcessStartedAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'When started to work',
...
CREATE TABLE IF NOT EXISTS `sysUserGroup` (
  ...
  `ExpireAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Set the expire date and time for this user group',
  `Tag` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Tag flags for multi purpose process.\n\nTags format is #tag# separated by ,\n\nExample:\n\n#tag01#,#tag02#,#my_tag03#,#super_tag04#,#other_tag05#',
  `Comment` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'A comment that the user can edit using the user interface.',
  `CreatedBy` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Name of user created the row.',
  `CreatedAt` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Creation date and time of the row.',
...
CREATE TABLE IF NOT EXISTS `sysUser` (
  ...
  `PasswordSetAt` varchar(60) NOT NULL COMMENT 'Last Date and time password set, default the same when created.',
  ...
  `ExpireAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Set the expire date and time for this user',
  `Tag` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Tag flags for multi purpose process.\n\nTags format is #tag# separated by ,\n\nExample:\n\n#tag01#,#tag02#,#my_tag03#,#super_tag04#,#other_tag05#',
  `Comment` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'A comment that the user can edit using the user interface.',
  `CreatedBy` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Name of user created the row.',
  `CreatedAt` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Creation date and time of the row.',
  ...
  `UpdatedAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Date and time of last update to the row.',
  `DisabledBy` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Name of user disabled the row',
  `DisabledAt` varchar(60) DEFAULT NULL COMMENT 'Disable Date and time of the row.',
  `ExtraData` json DEFAULT NULL COMMENT 'Extra data information, generally in json format',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `sysActionToken` (
  ...
  `UpdatedBy` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Name of user updated the row.',
  `UpdatedAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Date and time of last update to the row.',
  `ExpireAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Set the expire date and time for this token',
  `ExtraData` json DEFAULT NULL COMMENT 'Extra data information, generally in json format',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `sysUserSignup` (
  ...
  `UpdatedBy` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Name of user updated the row.',
  `UpdatedAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Date and time of last update to the row.',
  `ExpireAt` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Set the expire date and time for this user signup',
  `ExtraData` json DEFAULT NULL COMMENT 'Extra data information, generally in json format',
  PRIMARY KEY (`Id`)
...
CREATE TABLE IF NOT EXISTS `sysUserSessionStatus` (
  ...
  `UpdatedAt` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT'Date and time of last update to the row.',
  `LoggedOutBy` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Name of user that logged out the session.',
  `LoggedOutAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Indicates the date and time of logout, to be different from NULL, it is assumed that the session which represents the row is no longer valid.',
  `ExtraData` json DEFAULT NULL COMMENT 'Extra data information, generally in json format',
...
CREATE TABLE IF NOT EXISTS `sysUserSessionPersistent` (
  ...
  `DisabledBy` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Name of user disabled the row.',
  `DisabledAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Disable Date and time of the row.',
  `ExpireAt` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Expiration date and time of the row.',
  `ExtraData` json DEFAULT NULL COMMENT 'Extra data information, generally in json format',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `sysSystemEventLog` (
  ...
  `EventAt` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Creation date and time of the event not the same of the creation of the row.',
