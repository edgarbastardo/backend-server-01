...
const debug = require( 'debug' )( '010_migrate_07' );
...
export default class Migrate {
  ...
  static async migrateUp( dbConnection: any, logger: any ): Promise<any> {
    ...
    try {
      ...
      let strSQL = "Select Latitude, Longitude From bizDeliveryOrderStatus limit 1, 1";
      ...
      try {
        ...
        strSQL = "ALTER TABLE `bizDeliveryOrderStatus`" +
                 "ADD COLUMN `Latitude` VARCHAR(30) NULL AFTER `Description`," +
